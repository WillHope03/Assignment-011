        ...
        if ($num>0){
            while ($result=mysqli_fetch_assoc($query)){
                ...
                <tr>
                    ...
                    <td>".$result['Course']."</td>
                    <td>
                        <a href='http://localhost/website-1/student+.insert.php' class='btn'>Add</a>
                        <a href='http://localhost/website-1/student+.update.php' class='btn'>Update</a>
                        <a href='http://localhost/website-1/student+.php?ID=".$result['ID']."' class='btn'>Delete</a>
                    </td>
                </tr>
                ";
            }
